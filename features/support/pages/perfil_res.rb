...
class RestaurantePage < SitePrism::Page
  ...
  element :dinheiro,
          '[class="nome-forma-pagamento self-center large-font text-left grey-text font-main"]'
  element :id_bairro,              '#bairro-549 p '
  element :infos,                  '[data-target="#modalInfos"]'
  element :joinha,                 '[id="joinha_positivo"]'
  element :cupons,
          '[class="col-lg-9 col-md-9 col-sm-9 col-8 font-info font-main small-padding-percent-top dark-purple-text text-left"]'
  ...
  element :avaliacao_titulo,
          '[class="blue-text text-center semi-bold-font no-padding-bottom font-main large-font"]'
